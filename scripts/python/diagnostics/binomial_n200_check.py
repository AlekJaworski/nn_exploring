"""binomial_n200 saturation diagnostic for 2d_binomial_logit_n200_k10_cr.
...
CASE = "2d_binomial_logit_n200_k10_cr"
...
def main():
    ...
    print(f"\n{'='*70}")
    print(f"binomial_n200 saturation diagnostic: {CASE}")
    print(f"{'='*70}\n")
